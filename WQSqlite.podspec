...
Pod::Spec.new do |s|
  s.name             = 'WQSqlite'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WQSqlite.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wuqiongaia@163.com/WQSqlite'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wuqiongaia@163.com' => 'wuqiongaia@163.com' }
  s.source           = { :git => 'https://github.com/wuqiongaia@163.com/WQSqlite.git', :tag => s.version.to_s }
